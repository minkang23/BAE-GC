...
def parse_args(init_vals, custom_parser=None):
    ...
    p.add_argument('--batch_size2', type=int,
                   default=_default(init_vals, 'batch_size2'),
                   required=_required(init_vals, 'batch_size2'),
                   help="Size of each minibatch.")
    ...
    p.add_argument('--coef_emb', type=float,
                   default=_default(init_vals, 'coef_emb'),
                   required=_required(init_vals, 'coef_emb'),
                   help='Coefficient of Embedding')
    ...
    vals['batch_size2'] = FLAGS.batch_size2
    del FLAGS.batch_size2
